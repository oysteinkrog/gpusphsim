...
for i in kron_g500-logn20.graph audikw1.graph cage15.graph coPapersCiteseer.graph kkt_power.graph   
do
	echo ./bin/test_bfs_4.0_x86_64 metis ../../../graphs/$i $OPTIONS --queue-sizing=1.4
	     ./bin/test_bfs_4.0_x86_64 metis ../../../graphs/$i $OPTIONS --queue-sizing=1.4 > eval/$SUFFIX/$i.$SUFFIX.txt
	sleep 10 
	echo ./bin/test_bfs_4.0_x86_64 metis ../../../graphs/$i $OPTIONS --queue-sizing=1.4 --mark-parents
	     ./bin/test_bfs_4.0_x86_64 metis ../../../graphs/$i $OPTIONS --queue-sizing=1.4 --mark-parents > eval/$SUFFIX/$i.$SUFFIX.parent.txt 
	sleep 10 
done
